...
def change_data_type(dirty_data):
    ...
    dirty_data['average_covered_charges'] = dirty_data['average_covered_charges'].astype(float)
    dirty_data['average_medicare_payments'] = dirty_data['average_medicare_payments'].astype(float)
    dirty_data['average_total_payments'] = dirty_data['average_total_payments'].astype(float)
    dirty_data['total_discharges'] = dirty_data['average_total_payments'].astype(int)
    return dirty_data
...
def full_clean():
    ...
    Assumption: Your data will be saved in a data folder and
    named "dirty_data.csv"
